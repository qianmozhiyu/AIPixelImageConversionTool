...
_PARAM_FIELDS = [
    ...
    "enable_aa_removal", "aa_removal_passes", "aa_removal_threshold",
    "denoise_grid_guard",
...
_FIELD_TYPES = {
    ...
    "enable_aa_removal": bool, "aa_removal_passes": int, "aa_removal_threshold": float,
    "denoise_grid_guard": bool,
